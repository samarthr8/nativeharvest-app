    ...
    <div style={{ background: "#f5f7f6", minHeight: "100vh", padding: "60px 20px" }}>
      ...
      <div style={{
        ...
        <div style={{ lineHeight: "1.7", fontSize: "15px", color: "#444", display: "flex", flexDirection: "column", gap: "20px" }}>
          ...
          <p>
            All products listed on the website are subject to availability. Because our products are crafted in small batches using traditional methods, slight variations in color, texture, or taste may occur. Prices for our products are subject to change without notice. We reserve the right to modify or discontinue a product at any time.
          </p>
          ...
          <p>
            Due to the consumable nature of our products, we do not accept returns on opened jars or packages. Cancellations are only permitted before the order has been dispatched. If a product arrives damaged or broken, the customer must notify us with photographic evidence within 48 hours of delivery to qualify for a replacement or refund.
          </p>
